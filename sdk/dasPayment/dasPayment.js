...
class DasPayment extends Resource {
     ...
     * DasPayment object
     *
     * @description When you initialize a DasPayment, the entity will not be automatically
...
exports.DasPayment = DasPayment;
let resource = {'class': exports.DasPayment, 'name': 'DasPayment'};
...
exports.create = async function (payments, {user} = {}) {
     ...
     * Create DasPayments
     *
     * @description Send a list of DasPayment objects for creation in the Stark Bank API
     *
     * Parameters (required):
     * @param payments [list of DasPayment objects]: list of DasPayment objects to be created in the API
     * @param Parameters (optional):
     * @param user [Project object]: Project object. Not necessary if starkbank.user was set before function call
     * 
     * Return:
     * @returns list of DasPayment objects with updated attributes
     *
     */
...
exports.get = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single DasPayment object previously created by the Stark Bank API by passing its id
     *
     * Parameters (required):
...
exports.pdf = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single DasPayment pdf file generated in the Stark Bank API by passing its id.
...
exports.query = async function ({ limit, after, before, tags, ids, status, user} = {}) {
     ...
     *
     * @description Receive a generator of DasPayment objects previously created in the Stark Bank API
     *
     * Parameters (optional):
     ...
     *
     * Return:
     * @returns generator of DasPayment objects with updated attributes
     *
     */
    let query = {
        limit: limit,
...
exports.delete = async function (id, {user} = {}) {
     ...
     *
     * @description Delete a DasPayment entity previously created in the Stark Bank API
     *
     * Parameters (required):
     ...
     *
     * Return:
     * @returns deleted DasPayment with updated attributes
     *
     */
