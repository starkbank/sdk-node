...
class Log extends Resource {
     ...
     *
     * @description Every time a DasPayment entity is modified, a corresponding DasPayment Log
...
exports.Log = Log;
let resource = {'class': exports.Log, 'name': 'DasPaymentLog'};
...
exports.get = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single DasPayment Log object previously created by the Stark Bank API by passing its id
     *
     * Parameters (required):
     ...
     *
     * Return:
     * @returns DasPayment Log object with updated attributes
     *
     */
...
exports.query = async function ({ limit = null, after = null, before = null, types = null, paymentIds = null, user = null} = {}) {
     ...
     *
     * @description Receive a generator of DasPayment Log objects previously created in the Stark Bank API
     *
     * Parameters (optional):
     ...
     * @param paymentIds [list of strings, default null]: list of DasPayment ids to filter retrieved objects. ex: ['5656565656565656', '4545454545454545']
     * @param user [Project object, default null]: Project object. Not necessary if starkbank.user was set before function call
     *
     * Return:
     * @returns list of DasPayment Log objects with updated attributes
     *
     */
    let query = {
        limit: limit,
