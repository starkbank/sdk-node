...
class Log extends Resource {
     ...
     *
     * @description Every time a IssPayment entity is modified, a corresponding IssPayment Log
...
exports.Log = Log;
let resource = {'class': exports.Log, 'name': 'IssPaymentLog'};
...
exports.get = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single IssPayment Log object previously created by the Stark Bank API by passing its id
     *
     * Parameters (required):
     ...
     *
     * Return:
     * @returns IssPayment Log object with updated attributes
     *
     */
...
exports.query = async function ({ limit = null, after = null, before = null, types = null, paymentIds = null, user = null} = {}) {
     ...
     *
     * @description Receive a generator of IssPayment Log objects previously created in the Stark Bank API
     *
     * Parameters (optional):
     ...
     * @param paymentIds [list of strings, default null]: list of IssPayment ids to filter retrieved objects. ex: ['5656565656565656', '4545454545454545']
     * @param user [Project object, default null]: Project object. Not necessary if starkbank.user was set before function call
     *
     * Return:
     * @returns list of IssPayment Log objects with updated attributes
     *
     */
    let query = {
        limit: limit,
