...
class IssPayment extends Resource {
     ...
     * IssPayment object
     *
     * @description When you initialize a IssPayment, the entity will not be automatically
...
exports.IssPayment = IssPayment;
let resource = {'class': exports.IssPayment, 'name': 'IssPayment'};
...
exports.create = async function (payments, {user} = {}) {
     ...
     * Create IssPayments
     *
     * @description Send a list of IssPayment objects for creation in the Stark Bank API
     *
     * Parameters (required):
     * @param payments [list of IssPayment objects]: list of IssPayment objects to be created in the API
     * @param Parameters (optional):
     * @param user [Project object]: Project object. Not necessary if starkbank.user was set before function call
     * 
     * Return:
     * @returns list of IssPayment objects with updated attributes
     *
     */
...
exports.get = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single IssPayment object previously created by the Stark Bank API by passing its id
     *
     * Parameters (required):
...
exports.pdf = async function (id, {user} = {}) {
     ...
     *
     * @description Receive a single IssPayment pdf file generated in the Stark Bank API by passing its id.
...
exports.query = async function ({ limit, after, before, tags, ids, status, user} = {}) {
     ...
     *
     * @description Receive a generator of IssPayment objects previously created in the Stark Bank API
     *
     * Parameters (optional):
     ...
     *
     * Return:
     * @returns generator of IssPayment objects with updated attributes
     *
     */
    let query = {
        limit: limit,
...
exports.delete = async function (id, {user} = {}) {
     ...
     *
     * @description Delete a IssPayment entity previously created in the Stark Bank API
     *
     * Parameters (required):
     ...
     *
     * Return:
     * @returns deleted IssPayment with updated attributes
     *
     */
