...
class InvoicePullRequest extends Resource {
     ...
     *
     * Parameters (required):
     * @param subscriptionId [string]: Unique of the InvoiceSubscription related to the invoice. ex: "5656565656565656"
     ...
     * @param externalId [string, default None]: a string that must be unique among all your InvoicePullRequests. Duplicated external_ids will cause failures. ex: "my-external-id"
