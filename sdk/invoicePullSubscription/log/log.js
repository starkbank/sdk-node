...
class Log extends Resource {
     ...
     *
     */
    constructor({ created, type, errors, subscription, id }) {
        super(id);
...
exports.Log = Log;
let resource = {'class': exports.Log, 'name': 'InvoicePullSubscriptionLog'};
...
exports.query = async function ({limit, after, before, types, subscriptionIds, user} = {}) {
    /**
     *
    ...
    let query = {
        limit: limit,
        after: check.datetime(after),
        before: check.datetime(before),
        types: types,
...
exports.page = async function ({ cursor, limit, after, before, types, subscriptionIds, user } = {}) {
    /**
     *
