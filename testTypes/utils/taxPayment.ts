...
const generateExampleNonBoletoPaymentsJson = require('./nonBoletoPayment').generateExampleNonBoletoPaymentsJson;
...
export const examplePayment = new starkbank.TaxPayment({
    barCode: '83660000001084301380074119002551100010601813',
    scheduled: '2020-03-29',
    description: 'pagando a conta'
});

const exampleDarfPayment = new starkbank.DarfPayment({
    revenueCode: '1240',
